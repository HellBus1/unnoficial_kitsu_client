...
import 'package:unnoficial_kitsu_client/feature/manga/widget/header_image_manga.dart';
import 'package:unnoficial_kitsu_client/feature/manga/widget/manga_page_list.dart';
          ...
          slivers: [
            SliverList(
              ...
              Container(
                ...
                child: HeaderImageManga(),
              ),
              Container(padding: EdgeInsets.all(10.sp), child: MangaPageList())
            ])),
          ],
        )),
      ),
