...
part of 'base_anime.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class WelcomeAdapter extends TypeAdapter<BaseAnime> {
  @override
  final int typeId = 0;

  @override
  BaseAnime read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, BaseAnime obj) {
    writer
      ..writeByte(5)
      ..writeByte(0)
      ..write(obj.id)
